...
export const sendKYCSubmissionAlert = async (
  adminEmail: string,
  adminName: string,
  member: { name: string; memberId: string; mobile: string; email: string; state: string }
): Promise<boolean> => {
  try {
...
export const sendKYCStatusMail = async (
  toEmail: string,
  userName: string,
  memberId: string,
...
export const sendBankStatusMail = async (
  toEmail: string,
  userName: string,
  memberId: string,
...
export const sendPayoutSettlementMail = async (
  toEmail: string,
  userName: string,
  cycleMonth: string,
  grossAmount: number,
