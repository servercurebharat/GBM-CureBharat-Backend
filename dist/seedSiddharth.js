...
async function seedHJ() {
    try {
        ...
        let plan = await Plan_1.default.findOne({ price: 399900 });
        if (!plan) {
            console.log('3999 Plan not found! Creating CureBharat Sampoorna Surksha Plus...');
            plan = new Plan_1.default({
                name: 'CureBharat Sampoorna Surksha Plus',
                price: 399900,
