...
exports.pushToCRMAndEmail = void 0;
const mailer_1 = require("./mailer");
const CRM_API_URL = 'https://crm.curebharat.com/api/customers';
const pushToCRMAndEmail = async (sale, plan) => {
    try {
        ...
        if (sale.customerEmail) {
            if (sale.enrollmentType === 'customer') {
                ...
                await (0, mailer_1.sendEmail)(sale.customerEmail, 'Complete Your CureBharat Profile', `Hello ${sale.customerName},<br/><br/>
           ...
           Regards,<br/>CureBharat Team`);
                ...
                await (0, mailer_1.sendEmail)(sale.customerEmail, 'Welcome to CureBharat Family!', `Hello ${sale.customerName},<br/><br/>
...
exports.pushToCRMAndEmail = pushToCRMAndEmail;
