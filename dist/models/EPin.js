...
const epinSchema = new mongoose_1.Schema({
    ...
    currentOwnerId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
...
exports.default = mongoose_1.default.models.EPin || mongoose_1.default.model('EPin', epinSchema);
