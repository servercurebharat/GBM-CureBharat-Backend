...
exports.hccFAQ = void 0;
exports.hccFAQ = [
    {
        id: 'hcc-dashboard-overview',
        category: 'Dashboard & Analytics',
        question: 'How do I read my HCC dashboard overview?',
        answer: 'Use the HCC dashboard as your personal business summary. Start with personal sales, direct commissions, wallet movement, promotion readiness, recent team joins, and any pending alerts. This helps you quickly tell whether your next focus should be sales, onboarding, KYC completion, or payout follow-up.',
    ...
    },
    {
        ...
        answer: 'Compare the dashboard cards with their source modules first. Check My Sales for policy activity, Finance Hub for wallet movement, Team Management for referral counts, and Notifications for unresolved alerts.',
    ...
    },
    {
        ...
        answer: 'Use My Business to review your personal growth activity in one place. Focus on personal sales, referral onboarding status, direct income movement, promotion readiness, and recent branch activity.',
    ...
    },
    {
        ...
        answer: 'Track your sales by reviewing daily movement, recent policy count, plan mix, and month-to-date totals.',
    ...
    },
    {
        ...
        answer: 'Track team growth by reviewing how many referrals joined, how many became active, and how many started contributing through real sales.',
    ...
    },
    {
        ...
        answer: 'Recruitment works best when you focus on both joining and activation. Bring in new referrals, guide them through registration, help them complete KYC if needed, and support their first sale or plan activation.',
    ...
    },
    {
        ...
        answer: 'Referral onboarding usually follows this workflow: identify the new member, complete registration, apply a valid pin if required, confirm sponsor linkage, and then help the member complete their initial setup.',
    ...
    },
    {
        ...
        answer: 'Team counts can look incorrect when recent referrals have not fully reflected in summary widgets, when filters are applied, or when inactive members are counted differently across views.',
    ...
    },
    {
        ...
        answer: 'To move from HCC to HCM, focus on the promotion rules tied to personal sales and recruit quality.',
    ...
    },
    {
        ...
        answer: 'Improve promotion readiness by growing both personal business and active referrals together.',
    ...
    },
    {
        ...
        answer: 'Promotion delay usually means one or more required conditions are incomplete.',
    ...
    },
    {
        ...
        answer: 'Rank progression for HCC is mainly driven by personal sales and the growth of a productive direct team.',
    ...
    },
    {
        ...
        answer: 'Track your commissions using Finance or Finance Hub. Review direct income, provisional balance, final balance, and recent ledger entries together.',
    ...
    },
    {
        ...
        answer: 'Start by confirming the sale exists, then check whether the plan is commissionable and whether the amount is still provisional instead of final.',
    ...
    },
    {
        ...
        answer: 'Wallet balance may look missing when the sale has not yet generated income, the credited amount is still provisional, or the summary has not refreshed yet.',
    ...
    },
    {
        ...
        answer: 'Provisional balance contains earnings that are credited but not yet settled for payout use.',
    ...
    },
    {
        ...
        answer: 'To withdraw earnings, first make sure your KYC is approved and the amount is in final balance.',
    ...
    },
    {
        ...
        answer: 'Payout delays usually happen because the amount is still provisional, KYC is pending, or the settlement cycle has not completed.',
    ...
    },
    {
        ...
        answer: 'Finance Hub is your main financial summary screen. Use it to review direct income, provisional and final balance, transaction ledger, payout movement, and deduction impact such as TDS.',
    ...
    },
    {
        ...
        answer: 'Increase sales by keeping your sale flow consistent and removing operational blockers.',
    ...
    },
    {
        ...
        answer: 'Open the New Sale screen, choose an active plan, enter the customer or member details, and add any required E-Pin information if applicable.',
    ...
    },
    {
        ...
        answer: 'Use My Sales to validate recent policy entries, compare sale history, and spot missing or mislinked records.',
    ...
    },
    {
        ...
        answer: 'A sale can appear missing if it was not submitted successfully, was entered with wrong details, or has not yet reflected in summary views.',
    ...
    },
    {
        ...
        answer: 'Use the Policy Certificates section to open or download certificates linked to completed policy sales.',
    ...
    },
    {
        ...
        answer: 'Open My KYC Status or Documents to review what has been uploaded and what is still pending.',
    ...
    },
    {
        ...
        answer: 'If KYC is pending, incomplete, or rejected, payout processing can be blocked even when earnings are visible in the wallet.',
    ...
    },
    {
        ...
        answer: 'KYC is usually rejected because the documents are unclear, incomplete, mismatched, or do not meet the required format.',
    ...
    },
    {
        ...
        answer: 'Use E-Pins from your pin wallet when registration or sale flows require a valid unused pin.',
    ...
    },
    {
        ...
        answer: 'My Pin Wallet shows your available, used, and transferred pins.',
    ...
    },
    {
        ...
        answer: 'To register a member using a pin, first confirm the member details, sponsor link, and the pin status.',
    ...
    },
    {
        ...
        answer: 'Pin-based registration usually fails because the pin is already used, belongs to someone else, or does not match the required value.',
    ...
    },
    {
        ...
        answer: 'An E-Pin usually fails because it is already used, assigned incorrectly, linked to the wrong plan value, blocked, or entered incorrectly.',
    ...
    },
    {
        ...
        answer: 'Use Notifications as your action queue for business follow-up.',
    ...
    },
    {
        ...
        answer: 'Raise a support ticket with the exact issue type, member or sale reference, and what you already checked.',
    ...
    },
    {
        ...
        answer: 'Start with three priorities: consistent personal sales, correct referral onboarding, and complete KYC.',
    ...
    },
    {
        ...
        answer: 'As HCC, your immediate focus is your direct sponsor, your own sales, and the referrals you personally bring in.',
    ...
    },
    {
        ...
        answer: 'To become a Health Care Manager (HCM), you need to achieve 50 active direct policy sales and ensure your referrals are active. Focus on personal sales first.',
    ...
    },
    {
        ...
        answer: 'As an HCC, you earn a flat 10% direct commission on all your personal sales. You do not earn override income until you reach HCM rank.',
