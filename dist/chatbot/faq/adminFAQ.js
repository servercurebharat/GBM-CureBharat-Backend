...
exports.adminFAQ = void 0;
exports.adminFAQ = [
    {
        id: 'admin-dashboard-overview-metrics',
        category: 'Dashboard & Analytics',
        question: 'How do I read the admin overview dashboard?',
        answer: 'Use the admin dashboard as the daily operational summary. Start with total users, active users, inactive users, total revenue, FTD revenue, and MTD revenue.',
    ...
    },
    {
        ...
        answer: 'Compare dashboard cards against Member List, sales reports, wallet summaries, and payout queue status.',
    ...
    },
    {
        ...
        answer: 'Use FTD reports to review daily sales performance, total revenue, total sales count, and top performers.',
    ...
    },
    {
        ...
        answer: 'Use MTD reports to review current month sales, revenue trends, state-wise contribution, and member growth.',
    ...
    },
    {
        ...
        answer: 'Use state performance analytics to compare revenue, active members, and leadership output by region.',
    ...
    },
    {
        ...
        answer: 'Review top leaders using direct count, team sales value, branch width, and active downline growth.',
    ...
    },
    {
        ...
        answer: 'Use Member List to search, filter, inspect, and manage all members across the MLM network.',
    ...
    },
    {
        ...
        answer: 'Validate role, sponsor link, KYC status, wallet summary, recent sales, and downline structure.',
    ...
    },
    {
        ...
        answer: 'Verify sponsor linkage using member profile data and genealogy tree structure.',
    ...
    },
    {
        ...
        answer: 'Inactive members usually fail monthly activity requirements such as sales or engagement rules.',
    ...
    },
    {
        ...
        answer: 'Review network growth using active members, hierarchy depth, sales activity, and branch expansion.',
    ...
    },
    {
        ...
        answer: 'Review Aadhaar, PAN, bank proof, and identity verification before approving KYC.',
    ...
    },
    {
        ...
        answer: 'Reject KYC when documents are incomplete, invalid, mismatched, or unreadable.',
    ...
    },
    {
        ...
        answer: 'Sort pending KYC by submission age, payout urgency, and verification completeness.',
    ...
    },
    {
        ...
        answer: 'Track provisional balance, final balance, and withdrawal history together.',
    ...
    },
    {
        ...
        answer: 'Provisional balance contains unsettled income. Final balance contains payout-ready earnings.',
    ...
    },
    {
        ...
        answer: 'Audit wallet ledger entries by tracing transaction type, cycle month, source member, and settlement status.',
    ...
    },
    {
        ...
        answer: 'Manual adjustments should only be used for verified finance corrections or operational exceptions.',
    ...
    },
    {
        ...
        answer: 'The commission engine distributes direct, override, and leadership income after a valid sale.',
    ...
    },
    {
        ...
        answer: 'Override commissions depend on sponsor hierarchy, active uplines, and qualifying sales volume.',
    ...
    },
    {
        ...
        answer: 'Leadership bonuses are distributed to qualified upper-level leadership roles in the MLM hierarchy.',
    ...
    },
    {
        ...
        answer: 'Missing commissions are usually caused by wrong genealogy, non-commissionable plans, or unsettled balances.',
    ...
    },
    {
        ...
        answer: 'Commission configuration controls direct, override, and leadership payout percentages.',
    ...
    },
    {
        ...
        answer: 'The payout cycle settles provisional income into final payout-ready balances.',
    ...
    },
    {
        ...
        answer: 'Review pending withdrawals using KYC status, final balance, and payout queue data.',
    ...
    },
    {
        ...
        answer: 'Withdrawals are rejected due to pending KYC, insufficient final balance, invalid bank details, or payout rules.',
    ...
    },
    {
        ...
        answer: 'Payout delays happen because of pending KYC, unsettled balances, finance backlog, or payment processing delays.',
    ...
    },
    {
        ...
        answer: 'Review payout history using cycle, status, member, and ledger deduction records.',
    ...
    },
    {
        ...
        answer: 'Use Product Catalog to manage plans, pricing, GST, business volume, and commission eligibility.',
    ...
    },
    {
        ...
        answer: 'Configure selling price, GST, business volume, and commission eligibility while creating or updating a plan.',
    ...
    },
    {
        ...
        answer: 'A commissionable plan is eligible for MLM income distribution through business volume calculations.',
    ...
    },
    {
        ...
        answer: 'Generate E-Pins by selecting the plan, quantity, and optional member assignment.',
    ...
    },
    {
        ...
        answer: 'Assign or transfer E-Pins carefully using the correct target member and plan value.',
    ...
    },
    {
        ...
        answer: 'Track used E-Pins using status, owner, used-by member, and transfer history.',
    ...
    },
    {
        ...
        answer: 'Pins fail because they are already used, blocked, mismatched, or assigned incorrectly.',
