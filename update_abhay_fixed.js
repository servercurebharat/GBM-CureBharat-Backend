...
async function updateDb(dbName) {
  ...
  // 1. Update Abhay Sonchhatra User (only mobile, since email is unique to Jaysukhbhai)
  await db.collection('users').updateOne(
    { name: /Abhay Sonchhatra/i },
    { $set: { mobile: '9727028826' } }
  );
  ...
  await db.collection('sales').updateOne(
    { customerName: /Abhay Sonchhatra/i },
    {
      $set: {
        ...
        customerEmail: 'jaysukhsonchhatra@gmail.com', // Not unique in sales
